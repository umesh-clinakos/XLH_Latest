...
OhdsiRTools::checkUsagePackage("XLHLatest")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/XLHLatest.pdf")
shell("R CMD Rd2pdf ./ --output=extras/XLHLatest.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("XLHLatest")
