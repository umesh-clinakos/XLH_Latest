...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (46287620,46287573,46287424,46287345,46287338,46287338,46275507)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (46287620,46287573,46287424,46287345,46287338,46275507)
  and c.invalid_reason is null
UNION
select distinct cr.concept_id_1 as concept_id
FROM
(
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (46287620,46287573,46287424,46287345,46287338,46275507)
UNION  select c.concept_id
  from @vocabulary_database_schema.CONCEPT c
  join @vocabulary_database_schema.CONCEPT_ANCESTOR ca on c.concept_id = ca.descendant_concept_id
  and ca.ancestor_concept_id in (46287620,46287573,46287424,46287345,46287338,46275507)
